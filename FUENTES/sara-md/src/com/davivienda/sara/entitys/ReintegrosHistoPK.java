 ...
 */
@Embeddable
public class ReintegrosHistoPK implements Serializable {
    ...
    public ReintegrosHistoPK() {
    }

    public ReintegrosHistoPK(Integer hCodigocajero, Date hFechasistema, Integer hTalon) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ReintegrosHistoPK)) {
            return false;
        }
        ReintegrosHistoPK other = (ReintegrosHistoPK) object;
    ...
    public String toString() {
        return "com.davivienda.sara.entitys.ReintegrosHistoPK[hCodigocajero=" + hCodigocajero + ", hFechasistema=" + hFechasistema + ", hTalon=" + hTalon + "]";
    }
