 ...
 */
@Entity
@Table(name = "HISTORICOAJUSTESMULTI")

@NamedQueries( {
    @NamedQuery(
    name = "Historicoajustesmulti.registroUnico",
            query = "select object(txm) from Historicoajustesmulti txm where txm.idhistoricoajustes = :idhistoricoajustes"),             
    @NamedQuery(
    name = "Historicoajustesmulti.todos", 
             query = "select object(txm) from Historicoajustesmulti txm")            
})

public class Historicoajustesmulti implements Serializable {
    ...
    public Historicoajustesmulti() {
    }

    public Historicoajustesmulti(Long idhistoricoajustes) {
        this.idhistoricoajustes = idhistoricoajustes;
    }

    public Historicoajustesmulti(Long idhistoricoajustes, String usuario, Integer codigocajero, String tipoajuste, Date fecha, Long valor) {
        this.idhistoricoajustes = idhistoricoajustes;
   ...
   public Integer getCodigooficinamulti() {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Historicoajustesmulti)) {
            return false;
        }
        Historicoajustesmulti other = (Historicoajustesmulti) object;
    ...
    public String toString() {
        return "com.davivienda.sara.entitys.Historicoajustesmulti[idhistoricoajustes=" + idhistoricoajustes + "]";
    }
