 ...
 */
@Embeddable
public class ReintegrosmultiefectivoPK implements Serializable {
    ...
    public ReintegrosmultiefectivoPK() {
    }

    public ReintegrosmultiefectivoPK(Integer hCodigocajero, Date hFechasistema, Integer hTalon) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ReintegrosmultiefectivoPK)) {
            return false;
        }
        ReintegrosmultiefectivoPK other = (ReintegrosmultiefectivoPK) object;
    ...
    public String toString() {
        return "com.davivienda.sara.entitys.ReintegrosmultiefectivoPK[hCodigocajero=" + hCodigocajero + ", hFechasistema=" + hFechasistema + ", hTalon=" + hTalon + "]";
    }
