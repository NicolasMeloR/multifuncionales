 ...
 */
@Entity
@Table(name = "TXMULTIFUNCIONALEFECTIVO")

@NamedQueries( {
    @NamedQuery(
    name = "Txmultifuncionalefectivo.registroUnico",
            query = "select object(txm) from Txmultifuncionalefectivo txm where txm.txmultifuncionalefectivoPK.codigotx = :codigotx and txm.txmultifuncionalefectivoPK.codigocajero = :codigocajero and txm.txmultifuncionalefectivoPK.fechacajero = :fechacajero"),             
    @NamedQuery(
    name = "Txmultifuncionalefectivo.todos", 
             query = "select object(txm) from Txmultifuncionalefectivo txm"),
    @NamedQuery(
            name = "Txmultifuncionalefectivo.TransaccionBuscarReintegros",
            query = "select object(obj) from Txmultifuncionalefectivo obj " +
    ...
    @NamedQuery(
            name = "Txmultifuncionalefectivo.TransaccionReintegrosXTalon",
            query = "select object(obj) from Txmultifuncionalefectivo obj " +
            "        where obj.txmultifuncionalefectivoPK.codigocajero =:codigoCajero and " +
            "              obj.txmultifuncionalefectivoPK.fechacajero between :fechaInicial and :fechaFinal and " +
            ...
            "        order by obj.txmultifuncionalefectivoPK.fechacajero"),
    @NamedQuery(
            name = "Txmultifuncionalefectivo.TransaccionesTalonUnico",
            query = "select COUNT(obj.transaccionconsecutivo),obj.transaccionconsecutivo from Txmultifuncionalefectivo obj " +
            "        where obj.txmultifuncionalefectivoPK.codigocajero =:codigoCajero and " +
...
public class Txmultifuncionalefectivo implements Serializable {
    private static final long serialVersionUID = 1L;
    @EmbeddedId
    protected TxmultifuncionalefectivoPK txmultifuncionalefectivoPK;
    @Column(name = "ESTADO")
    ...
    public Txmultifuncionalefectivo() {
    }

    public Txmultifuncionalefectivo(TxmultifuncionalefectivoPK txmultifuncionalefectivoPK) {
        this.txmultifuncionalefectivoPK = txmultifuncionalefectivoPK;
    }

    public Txmultifuncionalefectivo(TxmultifuncionalefectivoPK txmultifuncionalefectivoPK, long secuencia) {
        this.txmultifuncionalefectivoPK = txmultifuncionalefectivoPK;
        this.secuencia = secuencia;
    }

    public Txmultifuncionalefectivo(Integer codigotx, Integer codigocajero, Date fechacajero) {
        this.txmultifuncionalefectivoPK = new TxmultifuncionalefectivoPK(codigotx, codigocajero, fechacajero);
    }

    public TxmultifuncionalefectivoPK getTxmultifuncionalefectivoPK() {
        return txmultifuncionalefectivoPK;
    }

    public void setTxmultifuncionalefectivoPK(TxmultifuncionalefectivoPK txmultifuncionalefectivoPK) {
        this.txmultifuncionalefectivoPK = txmultifuncionalefectivoPK;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Txmultifuncionalefectivo)) {
            return false;
        }
        Txmultifuncionalefectivo other = (Txmultifuncionalefectivo) object;
    ...
    public Txmultifuncionalefectivo actualizarEntity(Txmultifuncionalefectivo obj) {           
        setTxmultifuncionalefectivoPK(txmultifuncionalefectivoPK);    
