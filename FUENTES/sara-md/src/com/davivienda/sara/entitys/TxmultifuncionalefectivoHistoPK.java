 ...
 */
@Embeddable
public class TxmultifuncionalefectivoHistoPK implements Serializable {
    ...
    public TxmultifuncionalefectivoHistoPK() {
    }

    public TxmultifuncionalefectivoHistoPK(Integer codigotx, Integer codigocajero, Date fechacajero) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TxmultifuncionalefectivoHistoPK)) {
            return false;
        }
        TxmultifuncionalefectivoHistoPK other = (TxmultifuncionalefectivoHistoPK) object;
    ...
    public String toString() {
        return "com.davivienda.sara.entitys.TxmultifuncionalefectivoHistoPK[codigotx=" + codigotx + ", codigocajero=" + codigocajero + ", fechacajero=" + fechacajero + "]";
    }
