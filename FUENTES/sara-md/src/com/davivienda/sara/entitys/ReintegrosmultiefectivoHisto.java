 ...
 */
@Entity
@Table(name = "REINTEGROSMULTIEFECTIVO_HISTO")

@NamedQueries( {
   
    @NamedQuery(
    name = "ReintegrosmultiefectivoHisto.todos", 
             query = "select object(txm) from ReintegrosmultiefectivoHisto txm"),
               @NamedQuery(
         name = "ReintegrosmultiefectivoHisto.RangoFecha",
         query = "select object(obj) from ReintegrosmultiefectivoHisto obj " +
            "        where  obj.hFecha between :fechaInicial and :fechaFinal " + 
            "        order by obj.tFechacajero") ,
     @NamedQuery(
     name = "ReintegrosmultiefectivoHisto.RegistroUnico",
     query = "select object(obj) from ReintegrosmultiefectivoHisto obj " +
      ...
      @NamedQuery(
         name = "ReintegrosmultiefectivoHisto.CajeroTalonCuenta",
         query = "select object(obj) from ReintegrosmultiefectivoHisto obj " +
...
public class ReintegrosmultiefectivoHisto implements Serializable {
    private static final long serialVersionUID = 1L;
    @EmbeddedId
    protected ReintegrosmultiefectivoHistoPK reintegrosmultiefectivoPK;
    ...
    public ReintegrosmultiefectivoHisto() {
    }

    public ReintegrosmultiefectivoHisto(ReintegrosmultiefectivoHistoPK reintegrosmultiefectivoPK) {
        this.reintegrosmultiefectivoPK = reintegrosmultiefectivoPK;
    }

    public ReintegrosmultiefectivoHisto(ReintegrosmultiefectivoHistoPK reintegrosmultiefectivoPK, Date hFecha, Integer hTipotransaccion, Integer hCodigooficina, Integer tCodigotransaccion, Integer tCodigocajero, Date tFechacajero, Long tSecuencia) {
        this.reintegrosmultiefectivoPK = reintegrosmultiefectivoPK;
        this.hFecha = hFecha;
    ...
    public ReintegrosmultiefectivoHisto(Integer hCodigocajero, Date hFechasistema, Integer hTalon) {
        this.reintegrosmultiefectivoPK = new ReintegrosmultiefectivoHistoPK(hCodigocajero, hFechasistema, hTalon);
    }

    public ReintegrosmultiefectivoHistoPK getReintegrosmultiefectivoHistoPK() {
        return reintegrosmultiefectivoPK;
    }

    public void setReintegrosmultiefectivoHistoPK(ReintegrosmultiefectivoHistoPK reintegrosmultiefectivoPK) {
        this.reintegrosmultiefectivoPK = reintegrosmultiefectivoPK;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ReintegrosmultiefectivoHisto)) {
            return false;
        }
        ReintegrosmultiefectivoHisto other = (ReintegrosmultiefectivoHisto) object;
    ...
    public String toString() {
        return "com.davivienda.sara.entitys.ReintegrosmultiefectivoHisto[reintegrosmultiefectivoPK=" + reintegrosmultiefectivoPK + "]";
    }
    
     public ReintegrosmultiefectivoHisto actualizarEntity(ReintegrosmultiefectivoHisto obj) {   
         
    setReintegrosmultiefectivoHistoPK(obj.reintegrosmultiefectivoPK);    
