 ...
 */
@Entity
@Table(name = "HISTORICOAJUSTES")
@NamedQueries(
{
         @NamedQuery(
         name = "HistoricoAjustes.RegistroUnico",
         query = "select object(obj) from HistoricoAjustes obj where obj.idHistoricoAjustes = :idHistoricoAjustes"),
         @NamedQuery(
         name = "HistoricoAjustes.todos",
         query = "select object(obj) from HistoricoAjustes obj order by obj.idHistoricoAjustes")})
         
public class HistoricoAjustes implements Serializable {
...
//    private String cuenta;
    ...
    public HistoricoAjustes() {
    }

    public HistoricoAjustes(Long idHistoricoAjustes) {
        this.idHistoricoAjustes = idHistoricoAjustes;
    }

    public HistoricoAjustes(Long idHistoricoAjustes, String usuario, Integer codigocajero, Integer codigoocca, String tipoajuste,String cuenta, Date fecha, BigDecimal valor,String talon, String error, String descripcionerror) {
        this.idHistoricoAjustes = idHistoricoAjustes;
...
//    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof HistoricoAjustes)) {
            return false;
        }
        HistoricoAjustes other = (HistoricoAjustes) object;
    ...
    public String toString() {
        return "com.davivienda.sara.entitys.HistoricoAjustes[idHistoricoAjustes=" + idHistoricoAjustes + "]";
    }
     public HistoricoAjustes actualizarEntity(HistoricoAjustes obj) {
