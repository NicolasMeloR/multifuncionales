 ...
 */
public class ReintegrosConsultaNotasDbServletHelper implements ReintegrosHelperInterface {

    private NotasDebitoSessionLocal session = null;
    private ReintegrosGeneralObjectContext objectContext = null;
    private String respuestaJSon;

    public ReintegrosConsultaNotasDbServletHelper(NotasDebitoSessionLocal session, ReintegrosGeneralObjectContext objectContext) {
...
//        }
    ...
    private String aJSon(Collection<Notasdebito> items) {
        String cadenaJSon = "";
        ...
        try {
            ...
            for (Notasdebito item : items) {
                ...
                itemJSon.put("codigoCajero", item.getNotasdebitoPK().getCodigocajero().toString());
                itemJSon.put("codigoOcca", item.getCodigoocca().toString());
                itemJSon.put("numeroCuenta", item.getNumerocuenta());
                itemJSon.put("fecha", com.davivienda.utilidades.conversion.Fecha.aCadena(item.getNotasdebitoPK().getFecha(), FormatoFecha.FECHA_HORA));
