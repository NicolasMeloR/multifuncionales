 ...
 * @author calvarez
 */
@ManagedBean(name = "ingNotaCreditoMultifuncionalBean")
@ViewScoped
public class IngresoNotaCreditoMultifucionalBean extends BaseBean implements Serializable {
