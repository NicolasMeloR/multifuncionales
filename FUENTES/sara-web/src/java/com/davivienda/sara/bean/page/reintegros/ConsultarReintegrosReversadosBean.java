...
import com.davivienda.sara.reintegros.general.helper.ConsultarReintegrosReversadosServletHelper;
 ...
 * @author jediazs
 */
@ManagedBean(name = "consultarReintegrosReversadosBean")
@ViewScoped
public class ConsultarReintegrosReversadosBean extends BaseBean implements Serializable {
    ...
    public void RevisarReintegrosBean() {
        try {
            ...
            if (reintegrosGeneralObjectContext != null) {
                dataInicial();
            }
    ...
    public void consultar() {
        ...
        try {
            ...
            reintegrosHelper = new ReintegrosConsultaServletHelper(reintegrosSessionLocal, reintegrosGeneralObjectContext, EstadoReintegro.REVERSADOEXITOSO.codigo, false);
            ...
            this.mostrarTabla = false;
            reintegrosGeneralObjectContext.getConfigApp().loggerApp.log(Level.SEVERE, ex.getMessage(), ex);
            abrirModal("SARA", Constantes.MSJ_ERROR_INTERNO, null);
        }
    }

    public void consultarND(ReintegrosRevisionDTO reintegro) {
        ...
        try {
            ...
            reintegrosGeneralObjectContext.setAtributo("codigoCajero",reintegro.getCodigoCajero());
            reintegrosGeneralObjectContext.setAtributo("fechaReversado",reintegro.getFechaReversado());
            reintegrosGeneralObjectContext.setAtributo("numeroCuenta", reintegro.getNumeroCuenta());
            reintegrosGeneralObjectContext.setAtributo("valor", reintegro.getValor());
            reintegrosHelper = new ConsultarReintegrosReversadosServletHelper(notasDebitoSessionLocal,reintegrosGeneralObjectContext);
            if (reintegrosHelper != null) {
                respuesta = reintegrosHelper.obtenerDatos();
    ...
    private JSONArray aJSonArray() {
        ...
        try {
            ...
            for (ReintegrosRevisionDTO item : this.listaData) {
                ...
                itemJSon.put("talon", item.getTalon());
