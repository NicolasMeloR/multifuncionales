 ...
 * @author jediazs
 */
@ManagedBean(name = "ingNotaCreditoBean")
@ViewScoped
public class IngresoNotaCreditoBean extends BaseBean implements Serializable {
    ...
    public void guardarNota() {
        System.err.println("IngresoNotaCreditoBean-guardarNota");
        String respuesta = "";
        try {
            ...
            reintegrosNotasObjectContext.getConfigApp().loggerAcceso.info("Solicitud generar log " + "guardarNotaCredito" + " por  " + reintegrosNotasObjectContext.getIdUsuarioEnSesion() + " desde " + reintegrosNotasObjectContext.getdireccionIP());
            ...
            reintegrosNotasObjectContext.setAtributoTalon(this.talon);
            reintegrosNotasObjectContext.setAtributo("tipoCuenta", this.cuentaSeleccionada);

            reintegrosHelper = new ReintegrosNotasGeneralServletHelper(reintegrosNotasProcesosSessionLocal, reintegrosNotasObjectContext, procesoReintegrosSessionLocal, confModulosAplicacionLocal, true);
        ...
        System.err.println("IngresoNotaCreditoBean guardarNota: resp " + respuesta);
    }
