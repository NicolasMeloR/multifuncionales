 ...
 *         &lt;element name="llaveRepetitivoSiguienteTrama" type="{http://OtrosIngresosEgresos.servicios.impl.procesadortransacciones.davivienda.com/}campoExtendidoDto" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlSeeAlso({
    RespuestaAnulacionChequesGdosDto.class,
    RespuestaIngresoGiroChqDto.class
})
