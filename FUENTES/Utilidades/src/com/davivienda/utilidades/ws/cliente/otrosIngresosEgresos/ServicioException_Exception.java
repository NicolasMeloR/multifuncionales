 ...
 * 
 */
@WebFault(name = "ServicioException", targetNamespace = "http://OtrosIngresosEgresos.servicios.impl.procesadortransacciones.davivienda.com/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: com.davivienda.sara.clientews.otrosIngresosEgresos.ServicioException
     */
