 ...
 * 
 */
@WebFault(name = "ServicioException", targetNamespace = "http://solictarnotadebitocuentacorrienteinterface.servicios.procesadortransacciones.davivienda.com/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: com.davivienda.sara.clientews.solicitarNotaDebitoCuentaCorrienteServiceATM.ServicioException
     */
