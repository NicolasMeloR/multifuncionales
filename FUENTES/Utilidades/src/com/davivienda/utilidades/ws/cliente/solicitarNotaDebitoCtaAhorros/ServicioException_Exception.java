 ...
 * 
 */
@WebFault(name = "ServicioException", targetNamespace = "http://servicios.davivienda.com/solicitarNotaDebitoCuentaAhorrosServiceTypes")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: com.davivienda.sara.clientews.solicitarNotaDebitoCtaAhorros.ServicioException
     */
