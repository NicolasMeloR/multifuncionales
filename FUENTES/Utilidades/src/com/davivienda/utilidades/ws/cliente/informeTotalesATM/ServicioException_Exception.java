 ...
 * 
 */
@WebFault(name = "ServicioException", targetNamespace = "http://InformeTotalesATM.servicios.impl.procesadortransacciones.davivienda.com/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: com.davivienda.sara.clientews.informeTotalesATM.ServicioException
     */
