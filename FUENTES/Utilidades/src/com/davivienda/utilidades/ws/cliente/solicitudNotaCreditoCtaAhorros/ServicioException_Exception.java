 ...
 * 
 */
@WebFault(name = "ServicioException", targetNamespace = "http://servicios.davivienda.com/solicitudNotaCreditoCtaAhorrosServiceTypes")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: com.davivienda.sara.clientews.solicitudNotaCreditoCtaAhorros.ServicioException
     */
