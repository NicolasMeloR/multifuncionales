 ...
 * 
 */
@WebFault(name = "ServicioException", targetNamespace = "http://servicio.autenticacionldap.davivienda.com/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: com.davivienda.sara.clientews.autenticarUsuarioLdap.ServicioException
     */
