 ...
 * 
 */
@WebFault(name = "ServicioException", targetNamespace = "http://servicios.davivienda.com/solicitarNotaDebitoCuentaCorrienteTypes")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: com.davivienda.sara.clientews.solicitarNotaDebitoCtaCorriente.ServicioException
     */
