 ...
 *         &lt;element name="llaveRepetitivoSiguienteTrama" type="{http://servicio.autenticacionldap.davivienda.com/}campoExtendidoDto" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlSeeAlso({
    RespuestaAutenticarUsuarioDTO.class
})
