 ...
 * 
 */
@WebFault(name = "ServicioException", targetNamespace = "http://servicios.impl.procesadortransacciones.davivienda.com/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: com.davivienda.utilidades.ws.cliente.ajusteCajerosAutomaticos.ServicioException
     */
