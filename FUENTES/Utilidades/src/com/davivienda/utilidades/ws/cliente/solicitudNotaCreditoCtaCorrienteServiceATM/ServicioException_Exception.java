 ...
 * 
 */
@WebFault(name = "ServicioException", targetNamespace = "http://solicitudnotacreditoctacorrienteinterface.servicios.procesadortransacciones.davivienda.com/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: com.davivienda.sara.clientews.solicitudNotaCreditoCtaCorrienteServiceATM.ServicioException
     */
