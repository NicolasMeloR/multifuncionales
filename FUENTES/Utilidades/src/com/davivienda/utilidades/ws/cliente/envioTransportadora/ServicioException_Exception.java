 ...
 * 
 */
@WebFault(name = "ServicioException", targetNamespace = "http://enviotransportadorainterface.servicios.procesadortransacciones.davivienda.com/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: com.davivienda.sara.clientews.envioTransportadora.ServicioException
     */
