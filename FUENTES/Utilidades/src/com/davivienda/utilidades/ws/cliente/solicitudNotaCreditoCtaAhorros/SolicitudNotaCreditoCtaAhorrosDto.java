 ...
 *         &lt;element name="llaveRepetitivaConsulta" type="{http://servicios.davivienda.com/solicitudNotaCreditoCtaAhorrosServiceTypes}CampoExtendidoDto" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="modoDeOperacion" type="{http://www.w3.org/2001/XMLSchema}short"/>
 *         &lt;element name="parametrosSeguridad" type="{http://servicios.davivienda.com/solicitudNotaCreditoCtaAhorrosServiceTypes}ParametrosSeguridadDTO"/>
 *         &lt;element name="perfil" type="{http://www.w3.org/2001/XMLSchema}short"/>
 *         &lt;element name="segundaClave" type="{http://servicios.davivienda.com/solicitudNotaCreditoCtaAhorrosServiceTypes}validacionSegundaClave"/>
 *         &lt;element name="total" type="{http://servicios.davivienda.com/solicitudNotaCreditoCtaAhorrosServiceTypes}validacionTotal"/>
