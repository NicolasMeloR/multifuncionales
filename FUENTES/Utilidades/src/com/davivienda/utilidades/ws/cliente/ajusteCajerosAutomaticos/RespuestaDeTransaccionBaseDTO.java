 ...
 *         &lt;element name="llaveRepetitivoSiguienteTrama" type="{http://servicios.impl.procesadortransacciones.davivienda.com/}campoExtendidoDto" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlSeeAlso({
    RespAjustarSobranteCajeroDto.class,
    RespuestaConsultaManejoEfectivoATMDto.class
})
